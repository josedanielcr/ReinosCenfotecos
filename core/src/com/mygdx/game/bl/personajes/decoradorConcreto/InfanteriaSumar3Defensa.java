...
public class InfanteriaSumar3Defensa extends ObjetoDecorado{//PUEDE DARLE 3 PUNTOS DE ATAQUE A CUALQUIER ALIADE DE INFANTERIA


    public InfanteriaSumar3Defensa(Personaje pPersonaje) {//aqui recibe el personaje que quiere decorar, sin son varios lo que hace es que le aplica el decorador en un aiteracion en el controller
