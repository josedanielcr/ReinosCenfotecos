...
int ataque=2;
    public ArtilleriaDoblePoderAtaque(Personaje  pPersonaje) {//aqui recibe el personaje que quiere decorar, sin son varios lo que hace es que le aplica el decorador en un aiteracion en el controller
    ...
    public int getAtaque() {
        ...
        return this.cPersonaje.getAtaque()*2;
    }
